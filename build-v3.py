...
<section class="section" style="padding-top:0;">
    <div class="container" style="text-align:center;">
        <div class="price-hero">
            <span class="old">$189.900</span>
            <span class="now">$119.900</span>
...
<section class="section section-bg">
    <div class="container">
        ...
        <table class="comp-table">
            ...
            <tr><td>Costo</td><td class="win">$119.900 una vez</td><td>$80-150K + cremas</td><td>$30-80K por visita</td></tr>
    ...
    <div class="container">
        <div class="checkout-card">
            ...
            <div class="price-hero" style="text-align:center;">
                <span class="old">$189.900</span>
                <span class="now">$119.900</span><br>
