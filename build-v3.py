...
<section class="hero">
    ...
    <div style="display:flex;align-items:center;justify-content:center;gap:12px;padding:0 20px 16px;max-width:var(--max-w);margin:0 auto;">
        <div style="flex:1;text-align:center;">
            <p style="font-size:11px;font-style:italic;color:var(--gray-500);margin-bottom:4px;">'Finalmente algo que funciona' 😍</p>
            <p style="font-size:10px;font-weight:600;color:var(--gray-600);">— Valentina, Medellín</p>
        </div>
        <div style="flex-shrink:0;width:170px;height:170px;background:var(--white);border-radius:50%;display:flex;align-items:center;justify-content:center;border:3px dashed var(--rose-light);position:relative;">
            <img src="creativos/super-anuncio-7.png" alt="Simply Straight" style="width:138px;height:138px;object-fit:cover;border-radius:50%;">
            <div style="position:absolute;bottom:-12px;background:var(--rose-dark);color:white;padding:4px 14px;border-radius:14px;font-size:12px;font-weight:700;">+500 vendidos ✨</div>
        </div>
        <div style="flex:1;text-align:center;">
            <p style="font-size:11px;font-style:italic;color:var(--gray-500);margin-bottom:4px;">'Es mágico, amiga' ✨</p>
            <p style="font-size:10px;font-weight:600;color:var(--gray-600);">— Sofía, Cali</p>
        </div>
    </div>

    <!-- Video tagline -->
    <div style="text-align:center;padding:0 20px 12px;">
        <span style="background:var(--gray-100);color:var(--gray-600);padding:6px 16px;border-radius:20px;font-size:12px;font-weight:600;">▶ Mujer real. Cabello real. Sin filtro.</span>
    </div>
    ...
    <div class="hero-content" style="padding-top:0;">
        ...
        <div style="display:flex;justify-content:center;gap:16px;margin-bottom:18px;font-size:11px;color:var(--gray-500);">
...
<section class="section">
    <div class="container">
        ...
        <div class="features-grid">
            ...
            <div class="feature-card"><span class="feature-icon">🌡️</span><h4>185°C ideal</h4><p>Temperatura justa para alisar sin quemar el cabello</p></div>
...
<section class="section section-bg">
    <div class="container">
        ...
        <div class="steps-list">
            <div class="step-item"><div class="step-circle">1</div><div class="step-text"><h3>Conéctalo</h3><p>Enchúfalo, enciéndelo y selecciona 185°C en la pantalla digital. Espera 30 segundos a que caliente.</p></div></div>
