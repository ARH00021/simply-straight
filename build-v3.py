...
<section class="hero">
    ...
    <div style="width:100%;max-width:420px;height:340px;margin:0 auto 16px;padding:0 20px;">
        <img src="creativos/hero-lujo.png" alt="Simply Straight ritual de belleza" style="width:100%;height:100%;object-fit:cover;border-radius:20px;box-shadow:0 12px 40px rgba(0,0,0,.12);">
    </div>
