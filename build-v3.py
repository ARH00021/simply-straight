        ...
        <div style="flex-shrink:0;text-align:center;">
            ...
            <div style="position:relative;width:200px;height:200px;margin:0 auto;">
                <div id="heroCarousel" style="position:relative;width:100%;height:100%;overflow:hidden;border-radius:16px;box-shadow:var(--shadow-lg);">
                    <img src="creativos/01-producto-principal.png" class="carousel-slide active" style="position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;border-radius:16px;opacity:1;transition:opacity 0.5s;">
                    <img src="creativos/03-antes-despues.png" class="carousel-slide" style="position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;border-radius:16px;opacity:0;transition:opacity 0.5s;">
                    <img src="creativos/05-unboxing.png" class="carousel-slide" style="position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;border-radius:16px;opacity:0;transition:opacity 0.5s;">
                </div>
                <!-- Dots -->
...
<section class="section">
    <div class="container">
        ...
        <div class="features-grid">
            ...
            <div class="feature-card"><span class="feature-icon">🌡️</span><h4>Temperatura ajustable</h4><p>Temperatura justa para alisar sin quemar el cabello</p></div>
...
<section class="section section-bg">
    <div class="container">
        ...
        <div class="steps-list">
            <div class="step-item"><div class="step-circle">1</div><div class="step-text"><h3>Conéctalo</h3><p>Enchúfalo, enciéndelo y selecciona la temperatura en la pantalla digital. Espera unos segundos a que caliente.</p></div></div>
